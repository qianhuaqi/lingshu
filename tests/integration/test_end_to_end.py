...
def test_client_disconnect_cancellation(app: LingShu) -> None:
    """Test that a client disconnect cancels the handler execution."""
    ...
    async def run() -> None:
        ...
        # Give server time to detect disconnect and cancel scope
